      ...
      <section className="py-8 sm:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-6 sm:gap-12 items-center">
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4 sm:mb-6">We are Reckon Sales Pvt. Ltd.</h2>
              <p className="text-xs sm:text-base text-muted leading-relaxed mb-3 sm:mb-4">
              ...
              <p className="text-xs sm:text-base text-muted leading-relaxed mb-4 sm:mb-6">
              ...
              <blockquote className="border-l-4 border-primary pl-3 sm:pl-4 py-1.5 sm:py-2 bg-surface-secondary/50 rounded-r-lg mb-3 sm:mb-4">
                <p className="text-xs sm:text-base text-foreground italic font-medium">
            ...
            <div className="relative flex flex-col gap-4 sm:gap-6">
              ...
              {/* Office Illustration */}
              <div className="relative bg-surface rounded-xl sm:rounded-2xl border border-border overflow-hidden shadow-md">
                <img 
              ...
              <div className="relative bg-surface rounded-xl sm:rounded-2xl border border-border p-4 sm:p-6 shadow-md">
                <h3 className="text-base sm:text-lg font-bold text-foreground mb-3 sm:mb-5 text-center">Reckon by the Numbers</h3>
                <div className="grid grid-cols-2 gap-2.5 sm:gap-4">
                  {[
                    ...
                    <div key={stat.label} className="text-center p-2.5 sm:p-3.5 rounded-lg sm:rounded-xl bg-surface-secondary border border-border/50">
                      <div className="text-lg sm:text-xl font-extrabold text-primary">{stat.value}</div>
                      <div className="text-[10px] sm:text-[11px] text-muted mt-0.5 sm:mt-1 font-semibold">{stat.label}</div>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 max-w-4xl mx-auto">
            {[
              ...
              return (
                <div key={item.title} className="p-3.5 sm:p-6 rounded-lg sm:rounded-xl bg-surface border border-border flex flex-col items-center">
                  <div className="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-primary/5 flex items-center justify-center mb-2.5 sm:mb-4">
                    <Icon className="w-4.5 h-4.5 sm:w-6 sm:h-6 text-primary" />
                  </div>
                  <h4 className="text-xs sm:text-base font-bold text-foreground mb-1 sm:mb-2">{item.title}</h4>
                  <p className="text-[11px] sm:text-xs text-muted leading-snug sm:leading-relaxed">{item.desc}</p>
                </div>
              );
            })}
          </div>
