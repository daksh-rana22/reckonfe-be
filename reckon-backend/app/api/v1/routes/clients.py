...
async def list_clients(db: AsyncSession = Depends(get_db)):
    ...
    return await ClientRepository.get_all(db)
...
async def add_client(
    ...
    return await ClientRepository.create(db, name=name, img=img_url)
...
async def reset_clients(
    ...
    return await ClientRepository.reset(db, DEFAULT_CLIENTS)
